...
int assemble_account_number(int secret_modifier) {
  int bank_number_part = khan::bank_number_part(secret_modifier) +
...
int assemble_code() {
  int red = khan::red::code_fragment() + zhang::red::code_fragment() +
            garcia::red::code_fragment();
  int blue = khan::blue::code_fragment() + zhang::blue::code_fragment() +
